...
sudo -u kojiadmin koji add-group-pkg dist-"$TAG_NAME"-build srpm-build ccoreutils cpio curl-bin git glibc-utils grep gzip make pigz plzip rpm-build sed shadow tar unzip wget xz
